...
<body class='hold-transition skin-green-light sidebar-mini fixed '>
	...
	<div class='wrapper'>
		<header class='main-header'>
			...
			<!-- ubah backgorund header bagian paling atas dengan background-color -->
		...
		<aside class='main-sidebar'>
			<section class='sidebar'>
				...
				<ul class=' sidebar-menu tree data-widget=' tree>
					...
					<li><a href='beranda.php'><i class="fas fa-home fa-2x fa-fw"></i> <span>Beranda</span></a></li><li class=' treeview'>
								<a href='#'>
						...
						<li class='treeview'>
							...
							<ul class='treeview-menu'>
								...
								<li><a href='data_ujian.php'><i class='fas fa-dot-circle fa-fw'></i> <span>Nilai</span></a></li>
							</ul>
						</li>
						<li class='treeview'>
		...
		<!-- ganti background di style->background ini -->
							...
							<div class='box box-solid'>
								<div class='box-header with-border'>
									...
									<div class='box-tools pull-right '>
										<!-- ganti bacground hijau dengan jenis btn lain, coba searching di google, karena disini btn-success otomatis dia hijau -->
										<button class='btn btn-sm btn-flat btn-success' data-toggle='modal' data-target='#tambahmapel'><i class='fa fa-check'></i> Tambah Data Guru</button>
										<button class='btn btn-sm btn-flat btn-success' data-toggle='modal' data-target='#importmapel'><i class='fa fa-upload'></i> Import Data Guru</button>
									</div>
								</div><!-- /.box-header -->
								<div class='box-body'>
									<div class='table-responsive'>
										...
										<?php
										include 'koneksi.php';
										include './Connetion/post_guru.php';
										$no = 1;
										$data = mysqli_query($koneksi,"select * from mguru");
										...
										<tr>
											...
											<!-- saya simpan direktori foto di upload/ -->
											<td><?php echo $d['foto']; ?></td>
											<td><?php echo $d['status_pegawai']; ?></td>
											<td hidden><?php echo $d['id_guru']; ?></td>
											<td hidden><?php echo $d['id_guru']; ?></td>
									...
									<div class='modal-body'>
										<form action='' method='post' enctype="multipart/form-data">
											<div class='form-group'>
												<label>ID</label>
												<input type='text' name='idguru' class='form-control' required='true' />
											</div>
											<div class='form-group'>
												<label>NIP</label>
												<input type='text' name='nipguru' class='form-control' required='true' />
											</div>
                                            <div class='form-group'>
												<label>Nama</label>
												<input type='text' name='namaguru' class='form-control' required='true' />
											</div>
                                            <div class='form-group'>
												<label>Tempat Lahir</label>
												<input type='text' name='tlahirguru' class='form-control' required='true' />
											</div>
											<div class='form-group'>
												<label>Tanggal Lahir: </label>
												<input style="padding: 4px;" type="date" name='lahirguru' class='form' required='true' />
											</div>
											<div class='form-group'>
												<label>Alamat</label>
												<!-- <input type='text' name='alamatguru' class='form-control' required='true' /> -->
												<textarea name="alamatguru" id="alamatguru" cols="30" rows="10" class="form-control"></textarea>
											</div>
                                            <div class='form-group'>
												<label>No KTP</label>
												<input type='text' name='ktpguru' class='form-control' required='true' />
											</div>
                                            <div class='form-group'>
												<label>Status Keluarga</label>
												<!-- <input type='text' name='statusguru' class='form-control' required='true' /> -->
												<select name="statusguru" id="statusguru" class="form-control" required>
                                            ...
                                            <div class='form-group'>
												<label>Jabatan</label>
												<input type='text' name='jabatanguru' class='form-control' required='true' />
											</div>
											<div class='form-group'>
												<label>Foto</label>
                                            ...
                                            <div class='form-group'>
												...
												<!-- <input type='text' name='pegawai' class='form-control' required='true' /> -->
												<select name="statuspegawai" id="statusguru" class="form-control" required>
											...
											<div class='modal-footer'>
												<div class='box-tools pull-right '>
													<button type='submit' name='simpandataguru' class='btn btn-sm btn-flat btn-success'><i class='fa fa-check'></i> Simpan</button>
				...
				$('#tableguru').Tabledit({
					...
					columns: {
						...
						editable: [
							...
							[6, 'alamatguru'],
							[7, 'ktpguru'],
							[8, 'statusguru','{"Menikah": "Menikah", "Lajang" : "Lajang"}'],
							[9, 'jabatanguru'],
							[10, 'foto'],
							[11, 'statuspegawai','{"Tetap": "Tetap", "Honorer" : "Honorer"}'],
							[12, 'identifier'],
						]
					},
	...
	<script>
		...
		var autoRefresh = setInterval(
			function() {
				// saya disable karena tidak ada waktunya
