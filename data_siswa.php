							...
							<div class='box box-solid'>
								...
								<div class='box-body'>
									<div class='table-responsive'>
										<table id='tabsiswa' class='table table-bordered table-striped'>
										...
										<?php
										include 'koneksi.php';
										include './Connetion/post_siswa.php';
										$no = 1;
										$kelas = mysqli_query($koneksi, "SELECT id_kelas,nama_kelas FROM mkelas");
										$data = mysqli_query($koneksi,"select * from msiswa");
									...
									<div class='modal-body'>
										<form action='' method='post' enctype="multipart/form-data">
											...
											<div class='form-group'>
												...
												<input type='text' name='namasiswa' class='form-control' required='true' />
											</div>
                                            <div class='form-group'>
												<label>Jenis Kelamin</label>
												<select name="gender_siswa" id="" class="form-control">
                                            ...
                                            <div class='form-group'>
												...
												<input type='text' name='tlahirsiswa' class='form-control' required='true' />
											</div>
                                            <div class='form-group'>
												<label>Tanggal Lahir</label>
												<input type='date' name='lahirsiswa' required='true' />
											</div>
                                            <div class='form-group'>
												<label>Alamat</label>
												<input type='text' name='alamatsiswa' class='form-control' required='true' />
											</div>
                                            <div class='form-group'>
												<label>No. HP</label>
												<input type='text' name='nohpsiswa' class='form-control' required='true' />
											</div>
											<div class='form-group'>
												<label>Foto</label>
                                            ...
                                            <div class='form-group'>
												...
												<input type='text' name='asalsiswa' class='form-control' required='true' />
											</div>
                                            <div class='form-group'>
												<label>Nama Orang Tua</label>
												<input type='text' name='ortusiswa' class='form-control' required='true' />
											</div>
                                            <div class='form-group'>
												<label>Pekerjaan Orang Tua</label>
												<input type='text' name='portusiswa' class='form-control' required='true' />
											</div>                
											<div class='modal-footer'>
												<div class='box-tools pull-right '>
													<button type='submit' name='simpansiswa' class='btn btn-sm btn-flat btn-success'><i class='fa fa-check'></i> Simpan</button>
				...
				$('#tabsiswa').Tabledit({
					...
					columns: {
						...
						editable: [
							[1, 'nis'],
							[2, 'namasiswa'],
							[3, 'gender_siswa', '{"W" : "Wanita", "L" : "Laki-Laki"}'],
							[4, 'tlahirsiswa'],
							[5, 'lahirsiswa'],
							[6, 'alamatsiswa'],
							[7, 'nohpsiswa'],
					...
					onSuccess: function (data, textStatus, jqXHR) {
						if (data.action == "delete") {
							$("#" + data.id).remove();
							$("#tabsiswa").DataTable().ajax.reload();
						}
                    }
				});
			  });
