							...
							<div class='box box-solid'>
								...
								<div class='box-body'>
									<div class='table-responsive'>
										...
										<?php
										include 'koneksi.php';
										include './Connetion/post_dataujian.php';
										$no = 1;
										$siswa = mysqli_query($koneksi, "SELECT nama_siswa FROM msiswa");
										$siswa2 = mysqli_query($koneksi, "SELECT nis,nama_siswa FROM msiswa");
										$mapel = mysqli_query($koneksi, "SELECT id_matpel,nama_matpel FROM mmatpel");
										$mapel2 = mysqli_query($koneksi, "SELECT nama_matpel FROM mmatpel");
										$data = mysqli_query($koneksi,"select * from tdata_ujian");
									...
									<div class='modal-body'>
										<form action='' method='post' enctype="multipart/form-data">
											<div class='form-group'>
												...
												<select name="namasiswa" id="namasiswa" class="form-control" required='true'>
													<?php 
											...
											<div class='form-group'>
												...
												<select name="nis" id="nis" class="form-control" required='true'>
													<?php 
														while($s = mysqli_fetch_array($siswa2)){
													 ?>
														<option value="<?php echo $s['nis']; ?>"><?php echo $s['nis'] . ' - '. $s['nama_siswa']; ?></option>
													 <?php 
													 	};
													 ?>
												</select>
											...
											<div class='form-group'>
												...
												<select name="idmapel" id="idmapel" class="form-control" required='true'>
													<?php 
														while($m = mysqli_fetch_array($mapel)){
													 ?>
														<option value="<?php echo $m['id_matpel']; ?>"><?php echo $m['id_matpel'] . ' - '. $m['nama_matpel']; ?></option>
													 <?php 
													 	};
													 ?>
												</select>
											...
											<div class='form-group'>
												...
												<select name="namamapel" id="namamapel" class="form-control" required='true'>
													<?php 
														while($m = mysqli_fetch_array($mapel2)){
													 ?>
														<option value="<?php echo $m['nama_matpel']; ?>"><?php echo $m['nama_matpel']; ?></option>
													 <?php 
													 	};
													 ?>
												</select>
	...
	<script>
		// edit####
			$(document).ready(function() {
				$('#tablenilai').Tabledit({
					url: './Connetion/updel_dataujian.php',
					dataType: "json",
					restoreButton: false,
					columns: {
						identifier: [1, 'id'],
