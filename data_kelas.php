							...
							<div class='box box-solid'>
								<div class='box-header with-border'>
									...
									<div class='box-tools pull-right '>
										<button class='btn btn-sm btn-flat btn-success' data-toggle='modal' data-target='#tambahmapel'><i class='fa fa-check'></i> Tambah Data Kelas</button>
										<button class='btn btn-sm btn-flat btn-success' data-toggle='modal' data-target='#importmapel'><i class='fa fa-upload'></i> Import Data Kelas</button>
									</div>
								</div><!-- /.box-header -->
								<div class='box-body'>
									<div class='table-responsive'>
										...
										<?php
										include 'koneksi.php';
										include './Connetion/post_kelas.php';
										$no = 1;
										$guru = mysqli_query($koneksi, "SELECT id_guru,nama_guru FROM mguru");
										$data = mysqli_query($koneksi,"select * from mkelas");
										...
										?>
											<tr>
												...
												<td hidden><?php echo $d['id_kelas']; ?></td>
												<td hidden><?php echo $d['id_kelas']; ?></td>
									...
									<div class='modal-body'>
										<form action='' method='post'>
											<div class='form-group'>
												...
												<input type='text' name='kodekelas' class='form-control' required='true' />
											</div>
											<div class='form-group'>
												<label>Nama Kelas</label>
												<input type='text' name='namakelas' class='form-control' required='true' />
											</div>
                                            <div class='form-group'>
												<label>ID Guru</label>
                                            ...
                                            <div class='form-group'>
												<label>NIS</label>
												<input type='text' name='niskelas' class='form-control' required='true' />
											</div>
                                            <div class='form-group'>
												<label>ID Tahun Ajaran</label>
												<input type='text' name='tahunajaran' class='form-control' required='true' />
											</div>
											<div class='modal-footer'>
												<div class='box-tools pull-right '>
													<button type='submit' name='simpankelas' class='btn btn-sm btn-flat btn-success'><i class='fa fa-check'></i> Simpan</button>
