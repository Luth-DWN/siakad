			...
			<section class='content'>
				<div class="d-flex justify-content-center">
					<div style="text-align:center;">
						<img src="./dist//img/logoaplikasi.png" style="width: 20vw; min-width:120px; max-width:180px;">
						<h1 style="font-size: 3vw;">Sistem Informasi Akademik</h1>
					</div>
				</div>
			</section><!-- /.content -->
		</div><!-- /.content-wrapper -->
		<footer class='main-footer hidden-xs'></footer>
			<div class='container'>
				<div class='pull-left hidden-xs'>
					<strong>
						<span id='end-sidebar'>&copy;2021 UBHARA JAYA 2021</span>
					</strong>
				</div>
	</div><!-- ./wrapper -->
