...
<body class='hold-transition skin-green-light sidebar-mini fixed '>
	...
	<div class='wrapper'>
		...
		<div class='content-wrapper' style='background-image: url(background.jpg);background-size: cover;Background-color:#808080;'>
							...
							<div class='box box-solid'>
								<div class='box-header with-border'>
									...
									<div class='box-tools pull-right '>
										<button class='btn btn-sm btn-flat btn-success' data-toggle='modal' data-target='#tambahmapel'><i class='fa fa-check'></i> Tambah Matpel</button>
										<button class='btn btn-sm btn-flat btn-success' data-toggle='modal' data-target='#importmapel'><i class='fa fa-upload'></i> Import Matpel</button>
									</div>
								</div><!-- /.box-header -->
								<div class='box-body'>
									<div class='table-responsive'>
										...
										<?php
										include 'koneksi.php';
										include './Connetion/post_mapel.php';
										$no = 1;
										$data = mysqli_query($koneksi,"select * from mmatpel");
										while($d = mysqli_fetch_array($data)){
											...
											<tr>
												...
												<td><?php echo $d['status_pelajaran']; ?></td>
												<!-- hidden input agar bisa mengedit primary key -->
												<td hidden><?php echo $d['id_matpel'] ?></td>
												<td hidden><?php echo $d['id_matpel'] ?></td>
												<!--  -->
								...
								<div class='modal-content'>
									...
									<div class='modal-body'>
										<form action='' method='post'>
                                            ...
                                            <div class='form-group'>
												<label>Status Pelajaran</label>
												<select name="statusmapel" id="statusmapel" class="form-control">
	...
	$(document).ready(function() {
				$('#tablemapel').Tabledit({
					url: './Connetion/updel_mapel.php',
					dataType: "json",
					restoreButton: false,
					columns: {
						identifier: [5, 'identifier'],
						editable: [
							// tidak bisa mengubah identifier
							[1, 'kodemapel'],
							[2, 'namamapel'],
							[3, 'statusmapel', '{"Aktif": "Aktif", "Tidak Aktif" : "Tidak Aktif"}'],
							[4, 'identifier']
						]
					},
